...
class ApiUserDatasourceImp implements UserDataSource {
  ...
  final String getUser = 'http://192.168.82.115:3000/api/user/viewAll';
  final String userCreateUrl = 'http://192.168.82.115:3000/api/user/createUser';
  final String deleteuserUrl = 'http://192.168.82.115:3000/api/user/delete?id=';
  final String updateuserUrl = 'http://192.168.82.115:3000/api/user/update?id=';
  // final Dio dio = Dio();
